            ...
            <div className="flex gap-12 p-5">
                <div className="flex items-start gap-30 p-5 bg-[#FFF0F5] rounded-md">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-3xl font-bold">${overview?.turnover}</p>
                ...
                <div className="flex items-start gap-30 p-5 bg-[#EFF6FF] rounded-md">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-3xl font-bold">${overview?.profit}</p>
                        <p className="text-sm text-gray-500">
                            <span className="text-green-700 font-bold">{overview?.profitChange}%</span> period of change
                        </p>
                    </div>
